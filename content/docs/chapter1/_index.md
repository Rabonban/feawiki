...
{{< figure src="FigureI1.jpg" caption="Mesh with 5 elements (Source:Young W. Kwon, Hyochoong Bang)" numbered="true" width="500">}}
...
{{< figure src="I3.jpg" caption="Eliminating rows and columns associated with a DOF (Source: Arabyan A., Youssefi K., Enrique C.)" numbered="true" width="500">}}
